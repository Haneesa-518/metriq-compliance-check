...
export const SECOND_SCHEDULE_PACKS: StandardPack[] = [
  pack(
    ...
    "g",
    ["baby food", "infant food", "weaning food"],
    "Above 1 kg, in multiples of 1 kg.",
  ),
  pack(
    "SS-02",
    "Weaning food / cereal-based infant food",
    "Food",
    [100, 200, 250, 500, 1000],
    "g",
    ["weaning", "infant cereal", "baby cereal"],
    "Above 1 kg, in multiples of 1 kg.",
  ),
  pack(
    "SS-03",
    "Biscuits",
    "Food",
    [25, 50, 60, 75, 100, 120, 150, 200, 250, 300, 350, 400, 500, 600, 750, 1000],
    "g",
    ["biscuit", "cookie", "cracker"],
    "Above 1 kg, in multiples of 500 g.",
  ),
  pack(
    "SS-04",
    "Bread (including brown bread)",
    "Food",
    [100, 200, 300, 400, 500, 600, 700, 800, 900, 1000],
    "g",
    ["bread", "bun", "pav"],
    "Above 1 kg, in multiples of 100 g.",
  ),
  pack(
    "SS-05",
  ...
  pack(
    ...
    "g",
    ["rice", "wheat", "atta", "flour", "dal", "pulse", "maida", "suji", "rava", "besan", "poha"],
    "Above 5 kg, in multiples of 5 kg.",
  ),
  pack(
    "SS-07",
    "Coffee",
  ...
  pack(
    "SS-09",
    "Edible oils, vanaspati and ghee",
    "Food",
    [50, 100, 200, 250, 500, 1000, 2000, 3000, 5000],
    "ml",
    [
      "edible oil",
      "sunflower oil",
    ...
    "Above 5 l, in multiples of 5 l.",
    "Sold by weight where the commodity is declared by weight.",
  ),
  pack(
    "SS-10",
    "Milk powder",
    ...
    [100, 200, 250, 500, 1000],
    "g",
    ["milk powder", "dairy whitener", "skimmed milk powder"],
    "Above 1 kg, in multiples of 1 kg.",
  ),
  pack(
    "SS-11",
  ...
  pack(
    ...
    "Beverage",
    [65, 100, 125, 150, 200, 250, 300, 500, 750, 1000, 1500, 2000, 2250, 2500],
    "ml",
    ["soft drink", "aerated", "cola", "carbonated", "beverage", "juice", "nectar"],
    "Above 2.5 l, in multiples of 500 ml.",
  ),
  pack(
    "SS-14",
    "Packaged drinking water and mineral water",
    "Beverage",
    [100, 150, 200, 250, 300, 500, 750, 1000, 1500, 2000, 5000, 20000],
    "ml",
    ["drinking water", "mineral water", "packaged water"],
    null,
  ),
  pack(
    "SS-15",
    "Detergents (powder and cake)",
    "Household",
    [50, 100, 150, 200, 250, 500, 1000],
    "g",
    ["detergent", "washing powder", "washing cake"],
    "Above 1 kg, in multiples of 500 g.",
  ),
  pack(
    "SS-16",
    ...
    "g",
    ["soap", "bathing bar", "toilet soap"],
    "Above 150 g, in multiples of 25 g.",
  ),
  pack(
    "SS-17",
    "Paints, varnishes and allied products",
    "Industrial",
    [50, 100, 200, 500, 1000, 2000, 4000, 5000, 10000, 20000],
    "ml",
    ["paint", "varnish", "enamel", "primer", "distemper"],
    "Above 20 l, in multiples of 5 l.",
  ),
  pack(
    "SS-18",
    "Cement in bags",
    ...
    "kg",
    ["cement"],
    "Other sizes only where specifically permitted.",
    "Bulk supply to industrial consumers.",
  ),
  pack(
    "SS-19",
    "Rice bran oil and cooking media in rigid containers",
    "Food",
    [500, 1000, 2000, 5000],
    "ml",
    ["rice bran oil", "cooking medium"],
    null,
  ),
  pack(
    "SS-20",
    ...
    "g",
    ["toothpaste", "tooth powder", "dental cream"],
    "Above 300 g, in multiples of 50 g.",
  ),
];
...
export const THIRD_SCHEDULE_WHEN_PACKED: WhenPackedCondition[] = [
  wp(
    "TS-01",
    "Commodities liable to lose weight by evaporation or drying",
    "Net quantity is the quantity at the time of packing.",
    "Declare net quantity at the time of packing; deficiency assessment must allow for permitted variation.",
    ["biscuit", "bread", "bakery", "namkeen", "wafer"],
  ),
  wp(
    "TS-02",
    "Commodities packed in liquid medium",
    "Drained weight is required in addition to net weight.",
    "Declare both net weight and drained weight of the solid contents.",
    ["in brine", "in syrup", "canned", "pickle", "in oil"],
  ),
  wp(
    "TS-03",
    "Frozen and chilled commodities",
    "Net quantity is the quantity of the frozen commodity excluding glaze.",
    "Declare net quantity excluding glazing water.",
    ["frozen", "iqf", "chilled"],
  ),
  wp(
    "TS-04",
    "Aerosol and pressurised packages",
    "Net quantity refers to the contents excluding the propellant container.",
    "Declare net contents; state propellant separately where required.",
    ["aerosol", "spray can", "pressurised"],
  ),
  wp(
    "TS-05",
    "Hygroscopic commodities",
    "Moisture gain or loss after packing is recognised.",
    "Declare net quantity at the time of packing and record ambient conditions at inspection.",
    ["salt", "sugar", "detergent powder", "milk powder"],
  ),
  wp(
    "TS-06",
    "Cement and similar bagged commodities",
    "Net weight determined at the time of packing.",
    "Declare weight at packing; lot sampling applies at inspection.",
    ["cement", "fertilizer", "fertiliser"],
  ),
];
...
export const FOURTH_SCHEDULE_QUANTITY_TYPES: QuantityTypeRule[] = [
  qt(
    ...
    ["g", "kg"],
    ["aerosol", "spray can"],
    "Net contents by weight; volume may be declared additionally.",
  ),
  ...
  qt(
    ...
    "weight",
    ["g", "kg"],
    ["compressed gas", "liquefied gas", "cylinder gas"],
    "Declare tare and gross weight where applicable.",
  ),
  qt(
    "QT-04",
    ...
    "Declare net weight of gas and tare weight of the cylinder.",
  ),
  qt(
    "QT-05",
  ...
  qt(
    ...
    ["m", "cm"],
    ["cable"],
    "Declare length; conductor size where required.",
  ),
  ...
  qt(
    ...
    "weight",
    ["kg"],
    ["fencing wire", "barbed wire"],
    "Length may be declared additionally.",
  ),
  qt(
    "QT-09",
    ...
    "weight",
    ["g", "kg"],
    ["fresh fruit", "vegetable", "fruits"],
    "May be sold by number where customarily so sold.",
  ),
  ...
  qt(
    ...
    "volume",
    ["ml", "l"],
    ["edible oil", "refined oil", "mustard oil", "sunflower oil", "groundnut oil", "olive oil"],
    "Weight declaration permitted where the commodity is customarily sold by weight.",
  ),
  qt(
    "QT-12",
    "Nails, screws and similar fasteners",
    "weight",
    ["g", "kg"],
    ["nail", "screw", "bolt", "rivet"],
    "Number may be declared additionally.",
  ),
  qt(
    "QT-13",
    ...
    "Weight declaration permitted for products customarily sold by weight.",
  ),
  qt(
    "QT-14",
    "Readymade garments",
    "number",
    ["number", "pieces"],
    ["garment", "shirt", "trouser", "t-shirt", "kurta", "saree", "apparel"],
    "Declare size/dimension as required.",
  ),
  qt(
    "QT-15",
    "Sauces, ketchup and similar semi-liquid foods",
    "weight",
    ["g", "kg"],
    ["sauce", "ketchup", "puree", "paste"],
    "Volume may be declared additionally.",
  ),
  qt(
    "QT-16",
    "Tyres and tubes",
  ...
  qt(
    ...
    "volume",
    ["ml", "l"],
    ["lotion", "shampoo", "conditioner", "toner", "perfume", "serum"],
  ),
  qt(
    "QT-19",
    "Cosmetics (solid / semi-solid)",
    "weight",
    ["g", "kg"],
    ["cream", "balm", "lipstick", "talc", "powder", "wax"],
  ),
  qt(
    "QT-20",
    "Soap and detergent cake",
    "weight",
    ["g", "kg"],
    ["soap", "detergent cake", "bathing bar"],
  ),
  ...
  qt(
    ...
    "volume",
    ["ml", "l"],
    ["water", "soft drink", "juice", "beverage", "cola"],
  ),
  qt("QT-24", "Tea and coffee", "weight", ["g", "kg"], ["tea", "coffee"]),
  qt(
    "QT-25",
    "Biscuits, bread and bakery products",
    "weight",
    ["g", "kg"],
    ["biscuit", "bread", "cookie", "cake", "rusk"],
  ),
  qt(
    "QT-26",
    "Sheets, films and foils sold as sheets",
    "number",
    ["number"],
    ["sheet", "foil sheet", "tissue"],
    "Declare dimensions of each sheet.",
  ),
  qt(
    "QT-27",
    "Floor coverings and fabric sold by length",
    "length",
    ["m"],
    ["fabric", "carpet", "floor covering", "cloth"],
    "Declare width.",
  ),
  qt(
    "QT-28",
    ...
    "area",
    ["m2", "cm2"],
    ["paper ream", "chart paper"],
    "Number of sheets and dimensions may also be required.",
  ),
];
...
export const INSPECTION_SAMPLING: InspectionSamplingRow[] = [
  {
    ...
    sampleSize: 3,
    acceptanceNumber: 0,
    sourceReference: "Fifth Schedule (see Rule 19)",
    status: "needs_verification",
  },
  {
    samplingId: "SS5-02",
  ...
  },
  {
    ...
    sampleSize: 13,
    acceptanceNumber: 1,
    sourceReference: "Sixth Schedule (see Rule 19)",
    status: "needs_verification",
  },
];
